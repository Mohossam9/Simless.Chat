...
public class WifiDirectBroadcastReceiver extends BroadcastReceiver{
	...
	public void onReceive(Context context,Intent intent) {
		...
		**********************************/
			...
			if(mManager!=null && mActivity instanceof wifi_connection_activity)
			{
				mManager.requestPeers(mChannel,((wifi_connection_activity)mActivity).getpeer());
			}
		}
	...
	public void activateGoToChat(String role){
		if(mActivity.getClass() == wifi_connection_activity.class){
			((wifi_connection_activity)mActivity).getGoToChat().setText("Start the chat "+role);
			((wifi_connection_activity)mActivity).getGoToChat().setVisibility(View.VISIBLE);
			((wifi_connection_activity)mActivity).getSetChatName().setVisibility(View.VISIBLE);
			((wifi_connection_activity)mActivity).getSetChatNameLabel().setVisibility(View.VISIBLE);
			((wifi_connection_activity)mActivity).getDisconnect().setVisibility(View.VISIBLE);
			((wifi_connection_activity)mActivity).getlistview().setVisibility(View.GONE);
			((wifi_connection_activity)mActivity).getText().setVisibility(View.GONE);
			((wifi_connection_activity)mActivity).getImagebutton().setVisibility(View.GONE);
